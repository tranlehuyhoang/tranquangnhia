      ...
      <Layout>
        ...
        <Container>
          ...
          <Section delay={0.3}>
            ...
            <List>
              <ListItem>
                <Link href="https://www.tiktok.com/@nghia82no1" target="_blank">
                  <Button
                    variant="ghost"
                    colorScheme="teal"
              ...
              <ListItem>
                <Link href="https://www.facebook.com/NoProoo.gym" target="_blank">
                  <Button
                    variant="ghost"
                    colorScheme="teal"
